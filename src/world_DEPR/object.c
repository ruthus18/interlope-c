...
Model_* model_create_from_info_(ModelInfo* info) {

}


void model_destroy_(Model_*) {
    
}


ObjectPhysics_* object_physics_create_from_info_(PhysicsInfo* info) {

}


void object_physics_destroy_(ObjectPhysics_* physics) {

}


Object_* object_create_from_info_(ObjectInfo* info) {
    Object_* obj = malloc(sizeof(Object_));

    obj->model = model_create_from_info_(info->model);
    obj->physics = object_physics_create_from_info_(info->physics);
}


void object_destroy_(Object_* obj) {
    object_physics_destroy_(obj->physics);
    model_destroy_(obj->model);
    free(obj);
}
